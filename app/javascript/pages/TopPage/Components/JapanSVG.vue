    ...
    <div class="col-md-5 p-lg-5 mx-auto my-5 align-self-center">
      ...
      >
        ...
        >
          ...
          >
            <g
              class="okinawa kyusyu-okinawa prefecture"
              data-code="47"
            ...
            <g
              class="kagoshima kyusyu kyusyu-okinawa prefecture"
              data-code="46"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="miyazaki kyusyu kyusyu-okinawa prefecture"
              data-code="45"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="oita kyusyu kyusyu-okinawa prefecture"
              data-code="44"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="kumamoto kyusyu kyusyu-okinawa prefecture"
              data-code="43"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="nagasaki kyusyu kyusyu-okinawa prefecture"
              data-code="42"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="saga kyusyu kyusyu-okinawa prefecture"
              data-code="41"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="fukuoka kyusyu kyusyu-okinawa prefecture"
              data-code="40"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="kochi shikoku prefecture"
              data-code="39"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="kagawa shikoku prefecture"
              data-code="37"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="tokushima shikoku prefecture"
              data-code="36"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="yamaguchi chugoku prefecture"
              data-code="35"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="hiroshima chugoku prefecture"
              data-code="34"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="okayama chugoku prefecture"
              data-code="33"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="shimane chugoku prefecture"
              data-code="32"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="tottori chugoku prefecture"
              data-code="31"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="wakayama kinki prefecture"
              data-code="30"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="shizuoka chubu prefecture"
              data-code="22"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="yamanashi chubu prefecture"
              data-code="19"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="ishikawa chubu prefecture"
              data-code="17"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="niigata chubu prefecture"
              data-code="15"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="saitama kanto prefecture"
              data-code="11"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="tochigi kanto prefecture"
              data-code="9"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="ibaraki kanto prefecture"
              data-code="8"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="fukushima tohoku prefecture"
              data-code="7"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="yamagata tohoku prefecture"
              data-code="6"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="miyagi tohoku prefecture"
              data-code="4"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
            ...
            <g
              class="aomori tohoku prefecture"
              data-code="2"
              stroke-linejoin="round"
              fill="#EEEEEE"
              fill-rule="nonzero"
      ...
      <div class="mt-3 d-flex justify-content-center w-100">
        <div>
          <div style="width: 16pt; height: 16pt;" />
          <div class="fs-6">
            登録数:
          </div>
        </div>
        <div
          ...
          class="ms-3"
        >
          <div :style="'width: 16pt; height: 16pt; background-color: '+color+'; margin: auto;'" />
          <div class="fs-6">
            {{ Math.floor(index*Math.max(...list)/5) }}~
          </div>
        </div>
      </div>
    </div>
...
export default{
  data(){
    return {
      list: [],
      colors: ['#d3d3d3', '#b0c4de', '#90ee90', '#ffff00', '#ffa500'],
    }
  },
  computed:{
  ...
  watch:{
    hotsprings(){
      ...
      prefs.forEach( ( pref ) => {
        const sum = this.hotsprings.filter(hotspring => {
          return hotspring.prefecture === prefectures[pref.dataset.code]
        }).length
    ...
    list(){
      ...
      prefs.forEach( ( pref, index ) => {
        const color = this.mapColor(this.list[index])

        // Set Initial Color
        pref.style.fill = color

        // Add Event
        this.mapEvent(pref, color)
      })
    }
  },
  methods: {
